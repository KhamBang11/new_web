                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="card p-4 shadow">
                            ...
                            <div class="row">
                                <div class="col-sm-9"><h2 class="text-primary text-bold">ລາຍຮັບ</h2></div>
                                <div class="col-sm-3">
                                    <router-link to="/IncomeDe" class="rout___one" >
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="card p-4 shadow">
                            <div class="row">
                                <div class="col-sm-9"><h2 class="text-danger text-bold">ລາຍຈ່າຍ</h2></div>
                                <div class="col-sm-3">
                                    <router-link to="/ExpenseDe" class="rout___ones" >
                                    <i class="nav-icon fas fa-arrow-circle-right"></i>
                                    ທັງໝົດ
                                </router-link>
                                </div>
                            ...
                            <div class="shadow-sm p-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group float-end d-flex">
                                            <input type="search" required v-model="searchExQuery" id=""
                                                class="form-control">
...
export default {
    ...
    data() {
        ...
        //     params.append('incomename',this.searchQuery,
