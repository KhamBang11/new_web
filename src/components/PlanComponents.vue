                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><router-link to="/PlanSuccess" class="text-bold text-dark"
                                    href="#">ເເຜນການສຳເລັດເເລ້ວ</router-link></li>
                                    <li class="breadcrumb-item"><router-link to="/PlannotSuccess" class="text-bold text-dark"
                                        href="#">ເເຜນການຍັງສຳເລັດເເລ້ວ</router-link></li>
                    ...
                    <div class="col-sm-5">
                        <div class="card shadow p-4">
                            <div class="shadow p-4">
                                <h1 class="text-center text-primary"><b>ເພີ່ມເເຜນການ</b></h1>
                            </div>
                            <div class="p-3">
                                <form action="" @submit.prevent="Createplan" method="post">
                                    <div class="form-group">
                                        <label for="name">ເເຜນການ <span class="text-danger">*</span></label>
                                        <input type="text" required v-model="name" class="form-control" id="">
                                    </div>
                                    <div class="form-group">
                                        <label for="tel">ອັດຕາສ່ວນ <span class="text-danger">*</span></label>
                                        <input type="number" required v-model="percent" class="form-control" id="">
                                    </div>
                                ...
                                <table class="table table-sm table-striped table-hover">
                                    ...
                                    <tbody>
                                        <tr v-for="plan in plans" :key="plan.id">
                                            ...
                                            <td>
                                                <button @click="Showdatatoedit(plan.id)" data-toggle="modal"
...
export default {
    ...
    data() {
        ...
        async Showplans() {
            try {
                const respone = await axios.get('http://localhost:3000/api/select-plan');
